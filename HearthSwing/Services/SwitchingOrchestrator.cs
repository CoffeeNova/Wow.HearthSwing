...
public sealed class SwitchingOrchestrator : ISwitchingOrchestrator
{
    ...
    )
    {
        ...
        if (versioningEnabled && existingSavedAccount is not null && _fs.DirectoryExists(existingSavedAccount.RootPath))
    ...
    private void SeedMissingCacheFilesFromSavedAccount(string wtfPath, ActiveAccountState activeAccount)
    {
